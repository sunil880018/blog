...
import {FrontentData} from "./Data";
import {Link} from "react-router-dom";


const AboutFrontend = (props) =>{

   const closeMenu = () =>{
      document.querySelector('.mobile-menu').classList.remove("open");
  }

    const value = FrontentData.find(x => x._id === props.match.params.id);
    console.log(props);
     return (
        <div className="aboutContent" onClick={closeMenu}>
               <p><Link to ="/frontent/" style={{color:"#262626"}}><i className="fas fa-chevron-left"></i> Back</Link></p>
           <div>
